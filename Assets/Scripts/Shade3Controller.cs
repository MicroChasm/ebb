...
public class Shade3Controller : MonoBehaviour {
    ...
    void Start()
    {
        ...
        else
        {
            ...
            dialog.answers[dialogIndex][2] = " If you find one called The Artist, tell her âThe chasm fills my handsâ and she will know what that means. She will be able to help you.  ";
